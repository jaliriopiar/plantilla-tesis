...
\item Variación sin discontinuidades naturales=\emph{Variación contínua}
\item Caracteres que la exiben = \emph{Caracteres cuantitativos o métricos}
\item La segregación de los genes no puede seguirse individualmente
\item Genética Cuantitativa o Genética Biométrica
\end{itemize}
\end{caja}
\end{frame}
